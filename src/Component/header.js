      ...
      <header className="bg-gray-900 text-white py-4 px-6 sticky top-0 z-50">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center mb-4 md:mb-0">
            <div className="bg-gray-700 w-10 h-10 rounded-full mr-3">
          ...
          <nav className="flex space-x-1 md:space-x-6">
            <a href="/projects" className="nav-link hover:text-blue-400 transition">
            ...
            <a href="#skills" className="nav-link hover:text-yellow-400 transition">
