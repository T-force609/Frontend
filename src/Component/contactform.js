...
const ContactForm = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try{
            ...
            const response = await fetch('http//localhost:8000/api/contact-request/', {
                method: 'POST',
                headers: {
                    ...
                    <div>
                        {[
                            ...
                            <label key={service.value}>
                                <input type="radio" value={service.value} className="" {...register('request_type', {request:'Please select a service type'})} />
                        ...
                        <div>
                            <div>
                                ...
                                {...register('budget')}>
                                    ...
                                    <option value='$1,000 - $5,000'>$1000 - $5,000</option>
