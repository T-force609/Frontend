...
const Home = () => {
    ...
    return (
        <div className="w-full min-h-screen flex flex-row-2 items-center justify-center lg:flex-row items-center justify-center md:flex-col items-center justify-center sm:flex-col items-center justity-center ">
            ...
            <div className="flex w-2/3 h-2/3 pt-20 justify-center ">
                <div className='flex flex-row w-[50%] h-[120px] items-center justify-center sm:w-[100%] mb-10'>
