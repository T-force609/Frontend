...
const Home = () => {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col md:flex-row ">
            <div className=" rounded-full overflow-hidden w-[300px] h-[300px] ml-4 mt-[100px] mr-4 mr-20 border-[10px] border-red-300 sm:w-[400px] h-[320px]">
            ...
            <div className="block w-full h-full md:flex w-2/3 h-2/3 pt-20 justify-center ">
                <div className='flex flex-row w-[100%] h-[120px] items-center justify-center sm:w-[80%] mb-[60px] '>
